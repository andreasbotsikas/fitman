...
#Define filter terms
filterTerms = ["diarioDESIGN_en","AndreuWorld","homedesigning","PicoFurniture","MueblesCanella","infurma","Drexel_Heritage","leroymerlin_es","BoConcept","BakerFurniture","CenturyFurnitur","AshleyHomeStore","#imm14","#mikado","#platecma","#habitat","#aidima","#livingroom","#ikea","#natuzzi","#concretefurniture","#spainfurniture","#MDW14","#coolfurniture", "#furnituretrends", "#furniture", "#ArtDesign","#furnitures","#interiordesign","#HomeDesignIdeas","#homedecor","@thecoolhunter","@HermanMiller","@kartellpeople","@ArtekPress","@E1E4furniture","@th_furniture"]

#Define accounts to follow
followAccounts = ["237343504","544344830","277036530","18025770","380205512","442703689","437843321","110660952","177650270","65158142","68688042","148464806","15238124","18084100","128505062","125932592","2179610520","111190036"]
...
streamer.filter(follow = followAccounts , track = filterTerms)
